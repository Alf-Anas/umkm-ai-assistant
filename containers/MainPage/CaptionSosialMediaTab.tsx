...
export type CaptionSosMedSettingType = {
    tema: string;
    nama_produk: string;
...
export const CaptionSosMedSettingInitial: CaptionSosMedSettingType = {
    tema: "",
    nama_produk: "",
    deskripsi_produk: "",
    harga_produk: "",
...
export default function CaptionSosialMediaTab() {
    const [setting, setSetting] = useState<CaptionSosMedSettingType>(
        CaptionSosMedSettingInitial
    );
